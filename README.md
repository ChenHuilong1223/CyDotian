...
In addition, for the convenience of researchers who are not good at using the command line, we have also developed a user-friendly GUI desktop platform (SAtoolkit), get the link below.
https://github.com/ChenHuilong1223/SAtoolkit
